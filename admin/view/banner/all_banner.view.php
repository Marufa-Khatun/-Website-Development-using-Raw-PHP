              ...
              <tr>
               ...
               <?php foreach($datas as $data): ?>
                  <tr>
                      ...
                      <td>
                          <a href="<?=adminUrl()?>/banner/single_banner.php?id=<?=$data['id']?>" class="btn btn-sm btn-secondary">View</a>
                          <a href="<?=adminUrl()?>/banner/edit_banner.php?id=<?=$data['id']?>" class="btn btn-sm btn-primary">Edit</a>
                          <a href="<?=adminUrl()?>/banner/del_banner.php?id=<?=$data['id']?>" class="btn btn-sm btn-danger">Delete</a>
                          <a href="<?=adminUrl()?>/banner/status.php?id=<?=$data['id']?>" class="btn btn-sm btn-<?=$data['status'] == 1 ? "warning": "success" ?>">
