                ...
                <div class="col-md-12 col-sm-12 ">
                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      ...
                      <form action="<?=adminUrl()?>/feature/add_feature.php" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left __web-inspector-hide-shortcut__" >
